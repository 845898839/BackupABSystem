...
namespace Tangzx.ABSystem
{
    ...
    public class AssetTarget : System.IComparable<AssetTarget>
    {
        ...
        public void BeforeExport()
        {
            ...
            //load assetbundle no problem   unload      asset
            //prefab 是根    引用一系列asset    若还被其他的根或者standalone引用 则设置为standalone 
            //说白了 就是  一个prefab一个包   若一个asset被两个包（包括单独包）以上引用  则asset也单独一个包
